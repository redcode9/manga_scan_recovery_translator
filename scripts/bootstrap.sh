...
echo
echo "     ./scripts/install-mitr.sh"
echo "     # oppure manualmente:"
echo "     mkdir -p \"\$HOME/tools/mitr\""
echo "     uv venv \"\$HOME/tools/mitr/.venv\""
echo "     uv pip install --python \"\$HOME/tools/mitr/.venv/bin/python\" manga-image-translator"
echo
echo "   Verifica:"
echo "     \"\$HOME/tools/mitr/.venv/bin/python\" -m manga_translator --help"
echo
